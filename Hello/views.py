...
def question_create(request):
    ...
    if request.method == 'POST':
        ...
        form = QuestionForm()
    context = {'form': form}
    return render(request, 'Hello/question_form.html', context)
...
def comment_create_question(request, question_id):
    ...
    if request.method == "POST":
        ...
        form = CommentForm()
    context = {'form': form}
    return render(request, 'Hello/comment_form.html', context)
...
def comment_delete_question(request, comment_id):
    ...
    if request.user != comment.author:
        ...
        return redirect('Hello:detail', question_id=comment.question_id)
    else:
        comment.delete()
    return redirect('Hello:detail', question_id=comment.question_id)
